...
class Event(Base):
    ...
    AWAY_TEAM_ID = Column(String(NAME_LENGTH)) # TDH extended from 3 to NAME_LENGTH
    ...
    BAT_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    BAT_HAND_CD = Column(String(1))
    RESP_BAT_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    RESP_BAT_HAND_CD = Column(String(1))
    PIT_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    PIT_HAND_CD = Column(String(1))
    RES_PIT_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    RES_PIT_HAND_CD = Column(String(1))
    POS2_FLD_ID = Column(String(NAME_LENGTH))  # TDH extended from length 8 to NAME_LENGTH
    POS3_FLD_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    POS4_FLD_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    POS5_FLD_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    POS6_FLD_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    POS7_FLD_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    POS8_FLD_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    POS9_FLD_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    BASE1_RUN_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    BASE2_RUN_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    BASE3_RUN_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    EVENT_TX = Column(String(100))
    LEADOFF_FL = Column(String(1))
    PH_FL = Column(String(1))
    BAT_FLD_CD = Column(String(2)) # Column(Integer) #TDH - edit to allow two char positions ie. 'RF'
    ...
    RUN1_RESP_PIT_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    RUN2_RESP_PIT_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    RUN3_RESP_PIT_ID = Column(String(NAME_LENGTH)) # TDH extended from length 8 to NAME_LENGTH
    ...
    REMOVED_FOR_PR_RUN1_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    REMOVED_FOR_PR_RUN2_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    REMOVED_FOR_PR_RUN3_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    REMOVED_FOR_PH_BAT_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    ...
    HOME_TEAM_ID = Column(String(NAME_LENGTH)) # TDH extended from length 3 to NAME_LENGTH
    BAT_TEAM_ID = Column(String(NAME_LENGTH)) # TDH extended from length 3 to NAME_LENGTH
    FLD_TEAM_ID = Column(String(NAME_LENGTH)) # TDH extended from length 3 to NAME_LENGTH
    ...
    BAT_ON_DECK_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    BAT_IN_HOLD_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    ...
    RUN1_RESP_CAT_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    RUN2_RESP_CAT_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    RUN3_RESP_CAT_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
    ...
    FLD_ID = Column(String(NAME_LENGTH))# TDH extended from length 8 to NAME_LENGTH
